...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
        <?php the_content(); ?>
        <?php echo get_the_term_list( $post->ID, 'country', 'Country: ', ', ', '' ); ?>
        <?php echo get_the_term_list( $post->ID, 'genre', 'Genre: ', ', ', '' ); ?>
        
        <span>Release Date: <?php echo get_post_meta($post->ID, 'release_date', true); ?></span>
        <span>Ticket Price: $<?php echo get_post_meta($post->ID, 'ticket_price', true); ?></span>
		<?php
			wp_link_pages( array(
